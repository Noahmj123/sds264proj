...
basketball_tibble <- function(team, year = 2025) {
  url = ("https://www.basketball-reference.com/teams/CLE/2025.html#all_team_and_opponent")
  robotstxt::paths_allowed("https://www.basketball-reference.com/teams/CLE/2025.html#all_team_and_opponent")
  teamsite <- read_html(url)
  team_opp_temp <- html_nodes(teamsite, "p")
  tttt <- html_text(team_opp_temp)
  tttt
