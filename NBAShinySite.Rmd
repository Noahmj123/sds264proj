...
plot_ly(x = ~free_throw_percent, y = ~mean_shot_ft, type = 'scatter', mode = 'markers', text = ~paste("Player: ", player, '<br>Team: ', team)) |>
      layout(xaxis = list(title = "Free Throw Percentage"),
             ...
             shapes = hline,
             showlegend = FALSE) |>
    add_trace(x = meanplayer$free_throw_percent, y = meanplayer$mean_shot_ft, type = "scatter", mode = "markers", color = I("red"), inherit = FALSE, name = "Player")
...
### I can't think of a good title lol
