...
shot_map <- nba_pbp |>
  ...
  filter(player_n %in% season25$player | player_n %in% c("Bogdan Bogdanovic", "Luka Doncic", "Nikola Jokic", "Alperen Sengun", "Dennis Schroder", "Nikola Vucevic", "Nikola Jovic", "Kristaps Porzingis")) |>
