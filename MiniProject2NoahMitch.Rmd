...
To loop through each url of team data, we only need to change the three letter team abbreviation to determine which team's page we are accessing. Instead of manually entering this list, I took it upon myself to scrape the names from 
